...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">الرئيسية <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">الاصناف  <span class="sr-only"></span></a> </li>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
							  ...
							  <li class="nav-item"><a href="registration.php" class="nav-link active">تسجيل جديد </a> </li>';
							}
						else
							{
        ...
        <section class="hero bg-image" data-image-src="images/coffe-nuts.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose </h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order </h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>الأكثر مبيعا هذا الشهر </h2>
                   <!-- <p class="lead">أسهل طريقة لطلب طعامك المفضل من بين أفضل 6 أطباق</p>-->
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="col-sm-8">
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
                                    <li><a href="#" class="selected" data-filter="*">الكل </a> </li>
									<?php 
